using HeartInsurance.Web.Areas.Patient.Models;
...
namespace HeartInsurance.Web.Areas.Patient.Controllers
{
    [Area("Patient")]
    public class HomeController : Controller
    {
        ...
        private void FetchData()
        {
            try
            {
                ...
                patients = JsonConvert.DeserializeObject<List<PatientModel>>(arr);
            }
            catch (Exception e)
            {
                throw e;
